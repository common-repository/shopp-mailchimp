...
Description: Customers who opt-in to email marketing from your WordPress ecommerce site during checkout are added to a specified list on MailChimp.
Version: 1.3
...
require_once('inc/class-mcapi.php');

Shopp_MailChimp::smartLoad();

class Shopp_MailChimp {
	public static $api_key;
	public static $listid;
	
	public static function smartLoad() {
		$instantiate = apply_filters('shoppMailChimpLoadBasic', true);
		if ($instantiate) { new Shopp_MailChimp; }
	}

	public function __construct() {
		add_action('admin_init', array($this, 'admin_css'));
		add_action('admin_menu', array($this, 'admin_menu'));
		add_action('shopp_order_success', array($this, 'add_to_mailchimp_list'));
		
		$this->api_key = get_option('shopp_mailchimp_api_key');
		$this->listid = get_option('shopp_mailchimp_listid');
	}

	public function admin_css() {
		wp_register_style( 'shopp-mailchimp-stylesheet', plugins_url( 'css/shopp-mailchimp.css', __FILE__ ), array(), '20140823' );
		wp_enqueue_style( 'shopp-mailchimp-stylesheet' );
	}
	...
	public function admin_menu() {
		...
		$page = add_submenu_page('shopp-101-extensions', 'MailChimp', 'MailChimp', 'shopp_menu', 'shopp-mailchimp', array($this, 'render_display_settings'));
        add_action( 'admin_print_styles-' . $page, 'admin_styles' );
		...
		<div class="metabox-holder">	
			...
			<div id="shopp-extensions-about-the-author" class="postbox">
				...
				<div class="inside">
					<table border="0" width="100%">
   					 	<tr>
                            <td width="70%"><div><img style="padding: 0px 15px 0px 0px; float:left" src="<?php echo plugins_url( 'shopp-mailchimp/images/lorenzo-orlando-caum-shopp-wordpress-150x150.jpg' , dirname(__FILE__) ); ?>" border="0" alt="Founder of Enzo12 LLC" width="150" height="150">
...
<?php	 	 
	...
	public function add_to_mailchimp_list($Purchase) {
		global $wpdb;
		
		$marketing = $wpdb->get_var("SELECT marketing FROM ".$wpdb->prefix."shopp_customer WHERE id = '".$Purchase->customer."'");
		
		if($marketing == "yes"){
			$mailchimp_api = new MCAPI($this->api_key);
			
			$mailchimp_api->listSubscribe($this->listid, $Purchase->email, array('FNAME'=>$Purchase->firstname,'LNAME'=>$Purchase->lastname), 'html', 'false', 'true');
			
		}
	}

	public function render_display_settings() {
		wp_nonce_field('shopp-mailchimp');	
		if(!empty($_POST['submit'])){
			$this->api_key = stripslashes($_POST['api_key']);
			$this->listid = stripslashes($_POST['listid']);
			
			update_option("shopp_mailchimp_api_key", $this->api_key);
			update_option("shopp_mailchimp_listid", $this->listid);
		}
?>
...
<div class="wrap">
	...
	<div class="postbox-container" style="width:65%;">
		<div class="metabox-holder">	
			...
			<div id="shopp-mailchimp-introduction" class="postbox">
				<h3 class="hndle"><span>Introduction</span></h3>
				<div class="inside">
					<p>This plugin integrates <a href="http://shopp101.com/go/shopp/" title="Learn more about Shopp">Shopp</a> with <a href="http://shopp101.com/go/mailchimp/" title="Learn more about MailChimp">MailChimp</a> and is part of the Shopp 101 extensions.</p> 
					<p>During checkout, a customer has the option to opt-in to email marketing. If they choose to do so, then they will be added to a specified email list on MailChimp.</p>
					...
					<p>Credit to MailChimp who created the PHP API Wrapper for the MailChimp API. <a href="http://apidocs.mailchimp.com/api/downloads/" title="Learn about the PHP API Wrapper for MailChimp">Learn more about the MailChimp API</a></p>
				</div>
			</div>

			<div id="shopp-mailchimp-general-settings" class="postbox">
				<h3 class="hndle"><span>Setup Tutorial</span></h3>
				<div class="inside">
				<p><strong>How to Find Your Information from MailChimp</strong><br /><br /><iframe src="http://player.vimeo.com/video/32530454?title=0&amp;byline=0&amp;portrait=0" width="600" height="300" frameborder="0" webkitAllowFullScreen allowFullScreen></iframe></p>
                <p>Pro-tip: After starting a video, click on the fullscreen button which appears to the right of the HD toggle.</p>
				</div>
			</div>
			
			<div id="shopp-mailchimp-support-feedback" class="postbox">
				<h3 class="hndle"><span>Support & Feedback</span></h3>
				<div class="inside">
                ...
                <p>You can share feedback via this a <a href="http://shopp101.com/go/shopp-extensions-survey/" title="Take a super short survey">short survey</a>. Takes just a few minutes &mdash; we promise!</p>
                <p>Feeling generous? You can support the continued development of the Shopp + Mailchimp by <a href="http://shopp101.com/go/donate-shopp-mailchimp/" title="Say thank you by purchasing Lorenzo a Redbull">buying me a Redbull</a>, <a href="http://shopp101.com/go/amazonwishlist/" title="Say thank you by gifting Lorenzo a book">ordering me a book</a> from my Amazon wishlist, or <a href="http://shopp101.com/go/tip-shopp-help-desk/" title="Say thank you by tipping Lorenzo via the Shopp Help Desk">tipping me</a> through the Shopp help desk.</p>
				</div>
			</div>
			
			<div id="shopp-mailchimp-settings" class="postbox">
				<h3 class="hndle"><span>MailChimp Settings</span></h3>
				<div class="inside">
                    <p>
			...
			<div id="shopp-mailchimp-about-the-author" class="postbox">
				<h3 class="hndle"><span>About the Author</span></h3>
				<div class="inside">
					<table border="0" width="100%">
   					 	<tr>
	...
	<div class="postbox-container" style="width:25%;">
		<div class="metabox-holder">
			...
			<div id="shopp-mailchimp-donate" class="postbox">
				<h3 class="hndle"><span><strong>Make a Donation!</strong></span></h3>
				<div class="inside">
					<p>Hi friend!</p>
					<p>If this plugin is helpful to you, then please <a href="http://shopp101.com/go/donate-shopp-mailchimp/" title="Say thank you by purchasing Lorenzo a Redbull">buy me a Redbull</a>.</p> 
					...
					<p>Your kindness is appreciated and will go towards <em>continued development</em> of the Shopp + MailChimp plugin.</p>
				</div>
			</div>
				
			<div id="shopp-mailchimp-subscribe" class="postbox">
			...
			<div id="shopp-mailchimp-have-a-question" class="postbox">
				<h3 class="hndle"><span>Have a Question?</span></h3>
				<div class="inside">
                    <p>Open a <a href="http://shopp101.com/help/" title="Open a new support ticket with Shopp 101">new support ticket</a> for Shopp + MailChimp</p>
			...
			<div id="shopp-mailchimp-news-from-oms" class="postbox">
				<h3 class="hndle"><span>News from Shopp 101</span></h3>
				<div class="inside">
			...
			<div id="shopp-mailchimp-recommendations" class="postbox">
